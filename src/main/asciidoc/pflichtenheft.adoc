...
|v0.1
|Nachrichten senden
a|Das System muss einem Benutzer die Möglichkeit bieten, Nachrichten zu dem Festivalleiter
zu senden.
...
a|
Das System muss einem Benutzer die Möglichkeit bieten, Nachrichten zu empfangen.

|[[F00009]]<<F00009>>
|v0.1
|
a|Das System muss in der Lage sein, Ticket zu einem Festival mit erstellen.
- Anzahl der Tickets
- Ticket Preis
...
stellen, einen Termin eines Festivals zu bearbeiten.
a|
...
|v0.1
|Das System muss einem Planer die Funktionalität zur Verfügung
stellen, neue Mitarbieter einzustellen.
a|
...
| Logins verteilen
a|
Das System muss einem Festivalmanager die Möglichkeit geben, die Logins an den Mitarbeiter zu verteilen.
...
| Ausrüstungen mieten
a|
Das System muss einem Planer die Möglichkeit bieten, die Benötigte Ausrüstungen (Agentur – Bühnenmaterial ) von einem anderen Anbieter
mieten
...
| Daten ändern
a|
Das System sollte die Funktionalität bieten, den Festivaldaten
ändern zu können.
...
|Barcode
a|
Das System sollte die Funktionalität bieten, QR Code für die Tickets zu erstellen.
