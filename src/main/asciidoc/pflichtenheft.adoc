...
|Akteure                     |Planer
|Auslöser                    |Ein Planer öffnet den "Personal" Tab.
...
Equipment usw. verursacht.
|Akteure                     |Planer
|Auslöser                    |Ein Planer öffnet den "Kosten" Tab.
|Voraussetzung(en)           a|Ein Planer ist eingeloggt.
|Essentielle Schritte        a|
|Erweiterungen               |
|Funktionale Anforderungen   |<<F0001>>
...
|Akteure                     |Planer
|Auslöser                    |Ein Planer möchte im "Kosten" Tab den Ticketpreis anpassen.
|Voraussetzung(en)           a|
