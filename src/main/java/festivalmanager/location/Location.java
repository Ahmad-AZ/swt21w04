...
public class Location {
	...
	public Location(String name, String adress, Money pricePerDay, long visitorCapacity, long stageCapacity,
			String image, String groundView) {
		this.setName(name);
	...
	public boolean addBooking(LocalDate startDate, LocalDate endDate) {
		...
		// Interval a = Interval.from(LocalDateTime.of(2021, 11, 1, 0,
		// 0)).to(LocalDateTime.of(2021, 11, 25, 23, 59));
		// Interval b = Interval.from(LocalDateTime.of(2021, 11, 5, 0,
		// 0)).to(LocalDateTime.of(2021, 11, 14, 23, 59));
